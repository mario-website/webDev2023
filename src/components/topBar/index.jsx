...
const Topbar = () => {
  ...
  const handleMenuClick = useCallback(() => {
    //* This function uses a functional update with 'prev => !prev' to toggle 'showMenu', ensuring accurate updates by always using the latest state value.
    //* This approach is recommended over using the possibly outdated 'showMenu' directly, which can be asynchronous in React.
    setShowMenu((prev) => !prev);
    //* As scrollPosition isn't used inside this function, it's no longer included in the useCallback dependencies.
  }, []);
